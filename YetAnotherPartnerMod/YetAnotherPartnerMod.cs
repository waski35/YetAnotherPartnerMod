...
namespace YetAnotherPartnerMod
{
    ...
    public class YetAnotherPartnerModClass
    {
                        ...
                        if (attacked_ped.IsValid())
                        {
                            if (attacked_ped != partner_Ped && !attacked_ped.IsPlayer)
                            {
                                ...
                                //{
                                     ...
                                     CallNative_arrest((void*)partner_Ped.Handle.Value, (void*)attacked_ped.Handle.Value);
        ...
        unsafe static void CallNative_arrest(void* partner, void* attacker)
        {
            Rage.Native.NativeArgument[] func_args = new Rage.Native.NativeArgument[2];
            func_args[0] = partner;
            func_args[1] = attacker;
            Rage.Native.NativeFunction.CallByName("TASK_ARREST_PED", typeof(void), func_args);
